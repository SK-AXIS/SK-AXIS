...
class VisionAnalyzer:
    ...
    def get_analysis_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_score": (
                                         face_score + smile_score + posture_score + eye_contact_score + gesture_score + blink_score) / 6
        }
