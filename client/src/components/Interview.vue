<template>
  <div class="fixed inset-0 bg-white z-50 overflow-auto">
    ...
    <!-- 오른쪽 하단 실시간 캠/분석 오버레이 -->
    <div class="fixed bottom-4 right-4 w-[480px] h-[288px] bg-gray-900 rounded-lg overflow-hidden shadow-lg z-50 flex items-center justify-center">
  <PoseMiniWidget style="width:640px;height:384px;" />
</div>
